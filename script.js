...
const workouts = {
    'A': [
        ...
        { name: "Lateral Raises", sets: [{w: 12.5, r: 13}, {w: 12.5, r: 13}, {w: 12.5, r: 11}], step: 0.5 }, // תיקון 0.5 ק"ג
    ...
    'C': [
        ...
        { name: "Lateral Raises (DB)", sets: [{w: 12.5, r: 13}, {w: 12.5, r: 13}, {w: 12.5, r: 11}], step: 0.5 }, // תיקון 0.5 ק"ג
...
function nextStep() {
    state.log.push({ 
        exIdx: state.exIdx, exName: state.currentExName, 
        w: document.getElementById('weight-picker').value, 
        r: document.getElementById('reps-picker').value, 
        rir: document.getElementById('rir-picker').value, isBW: state.currentEx.isBW
    });
